# Prompt 05 — Planejamento da edição do áudio
...
Com base em um episódio com dois apresentadores, proponha uma sequência simples de edição que contemple:

- organização das falas;
- remoção de silêncios excessivos;
- redução de ruídos quando necessário;
- ajuste de volume entre as vozes;
