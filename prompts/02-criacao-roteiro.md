...
3. discussão sobre automação e transformação de tarefas;
4. exemplos de áreas profissionais afetadas;
5. novas competências profissionais;
6. colaboração entre humanos e IA;
7. limitações e cuidados;
8. conclusão e encerramento.

Use linguagem natural, clara e adequada para fala. Evite exageros como "a IA vai acabar com todos os empregos". Diferencie transformação de tarefas de substituição completa de profissões.
